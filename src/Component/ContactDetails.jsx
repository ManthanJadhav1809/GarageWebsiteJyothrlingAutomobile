        ...
        <div className="contact-content">
          <div className="contact-info">
            <div className='contact-card'>
              ...
              <p>Near Hotel Shangreela In front of Kalamba Water Tank Kalamba Ring Road Kolhapur 416012</p>
            </div>
            <div className='contact-card'>
              <h2><FontAwesomeIcon icon={faPhone} shake /> PHONE NUMBER</h2>
              <a href="tel:+919890926305" style={{ textDecoration: "none", color: "white" }}>9890926305</a>
            </div>
            <div className='contact-card'>
              <h2><FontAwesomeIcon icon={faClock} fade /> TIMINGS</h2>
              <p>Monday: Closed</p>
